...
number of nodes with degree two in the tree.
*/
...
int count_deg2_nodes(node *root)
{
    ...
    {
        int deg2_nodes_in_left_subtree=count_deg2_nodes(root->left);
        int deg2_nodes_in_right_subtree=count_deg2_nodes(root->right);
        if(root->left!=nullptr && root->right!=nullptr)
        return deg2_nodes_in_left_subtree+deg2_nodes_in_right_subtree+1;
        else
        return deg2_nodes_in_left_subtree+deg2_nodes_in_right_subtree;
    }
}
...
int main()
{
    ...
    cout<<"\nTotal number of nodes with degree 2 in the given tree is : "<<count_deg2_nodes(root);
}