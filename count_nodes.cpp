...
int count_nodes(node *root)
{
    ...
    {
        int nodes_in_left_subtree=count_nodes(root->left);
        int nodes_in_right_subtree=count_nodes(root->right);
        return nodes_in_left_subtree+nodes_in_right_subtree+1;
    }
}
...
int main()
{
    ...
    cout<<"\nTotal number of nodes in the given tree is : "<<count_nodes(root);
}